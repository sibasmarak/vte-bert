...
train_dataset = VisualBERTDataset(test['padded_premises'], test['padded_hypotheses'], test['labels'], 
                                    test['image_name'], test_features)
dev_dataset = VisualBERTDataset(dev['padded_premises'], dev['padded_hypotheses'], dev['labels'],
...
model = VisualConcatBERTModel(embeddings, embedding_size, hidden_size, num_labels)
